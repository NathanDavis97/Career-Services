...
Hello, my name is Nathan Davis and I am a software developer with training in Html, JavaScript, vue, and c#. While I was growing up,I had always liked solving puzzles and logic problems so I knew that I wanted to encapsulate some of those ideals into the career that I would be in. I spent a few years at different jobs being trained in customer service and problem solving which have helped me work alongside others. I also had experiences in multiple fields that broadened my horizons of what a career could look like in different forms. Ultimately though, I realized that I wanted to do something more than what I was doing at my previous jobs.I started to look into coding and software development and found that I enjoyed the creative yet logical aspects. This process of trying and learning led me to seek out the training for full stack development. Now, I have built multiple full stack applications and have worked with a large variety of partners. I was taught to use Scrum as a tool to keep on track and work throughout the production of the applications we created. I also have quite a bit of experience with using git and github as well as using sites to host single page applications. I have learned that I really enjoy being able to make applications that are easy to use for clients that can have a true impact on their life. I want to work to make people’s lives easier with the programs I create as well as make them accessible for those who need to use them.

### Drive Link for video
https://drive.google.com/file/d/1ULP5BlUcKbD4NKrwJ7es0p_wgy5etZhw/view?usp=sharing
